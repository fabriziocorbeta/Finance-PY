# Create OAuth applications for FinancePY's first-party apps
# These are the only OAuth apps that will exist - external developers use API keys

# FinancePY Mobile App (shared across iOS and Android)
mobile_app = Doorkeeper::Application.find_or_create_by(name: "FinancePY Mobile") do |app|
