...
function renderHistoryPage() {
   ...
   txs.forEach(t => {
      ...
      if(isInc) runningBalance += amt;
      else if(isExp) runningBalance -= amt;
   ...
   if(flist) {
      ...
      txsReversed.forEach(t => {
         let amt = parseFloat(t.amount)||0;
         if(t.type === 'income') rBalance += amt;
         else if(t.type === 'expense') rBalance -= amt;
      ...
      mappedTxs.forEach(t => {
         ...
         fhtml += `<tr>
            ...
            <td class="mono" style="text-align:right;color:${col}">${sign}${fmt(t.amtC, cTag)}</td>
