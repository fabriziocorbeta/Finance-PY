...
function renderAll(){renderDashboard();renderTxs();renderInventory();renderSales();renderOrders();renderInvoices();renderContacts();renderAccounts();renderBudgets();renderSubscriptions();renderGoals();renderAdvice();renderDebtsPage();if(typeof renderHistoryPage==='function')renderHistoryPage();if(typeof renderReceivables==='function')renderReceivables();if(typeof renderPatrimonio==='function'&&S.curPage==='patrimonio')renderPatrimonio();if(typeof renderProfitability==='function')renderProfitability();updateBadges();if(typeof populateTxAccountSelect==='function')populateTxAccountSelect();}
