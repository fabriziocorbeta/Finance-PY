...
class Api::V1::FleetVehiclesController < Api::V1::BaseController
  ...
  def index
    ...
    @pagy, @fleet_vehicles = pagy(
      fleet_vehicles_scope.order(created_at: :desc, id: :asc),
  ...
  def destroy
    ...
    render json: { message: "Fleet vehicle deleted successfully" }, status: :ok
  rescue => e
  ...
  private
    ...
    def fleet_vehicle_params
      ...
      raw.permit(:plate, :brand, :model, :year, :status, :notes)
    end
