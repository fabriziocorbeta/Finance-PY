module Accountable
  ...
  TYPES = %w[Depository Investment Crypto Property Vehicle OtherAsset CreditCard Loan OtherLiability Receivable]
  ...
  included do
    ...
    # See FamilyIdPropagatable. Covers Receivable.new(account: Account.new
    # (...)) as well as any other construction where the accountable is
    # built as the outer object -- mirrors Account's own
    # propagates_family_id_to :accountable push callback.
    pulls_family_id_from :account
  end
