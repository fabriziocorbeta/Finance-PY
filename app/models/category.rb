  ...
  class << self
    ...
    private
      def default_categories
        [
          [ I18n.t("models.category.default_income"), "#22c55e", "circle-dollar-sign" ],
          [ I18n.t("models.category.default_food_and_drink"), "#f97316", "utensils" ],
          [ I18n.t("models.category.default_groceries"), "#407706", "shopping-bag" ],
          [ I18n.t("models.category.default_shopping"), "#3b82f6", "shopping-cart" ],
          [ I18n.t("models.category.default_transportation"), "#0ea5e9", "bus" ],
          [ I18n.t("models.category.default_travel"), "#2563eb", "plane" ],
          [ I18n.t("models.category.default_entertainment"), "#a855f7", "drama" ],
          [ I18n.t("models.category.default_healthcare"), "#4da568", "pill" ],
          [ I18n.t("models.category.default_personal_care"), "#14b8a6", "scissors" ],
          [ I18n.t("models.category.default_home_improvement"), "#d97706", "hammer" ],
          [ I18n.t("models.category.default_mortgage_rent"), "#b45309", "home" ],
          [ I18n.t("models.category.default_utilities"), "#eab308", "lightbulb" ],
          [ I18n.t("models.category.default_subscriptions"), "#6366f1", "wifi" ],
          [ I18n.t("models.category.default_insurance"), "#0284c7", "shield" ],
          [ I18n.t("models.category.default_sports_and_fitness"), "#10b981", "dumbbell" ],
          [ I18n.t("models.category.default_gifts_and_donations"), "#61c9ea", "hand-helping" ],
          [ I18n.t("models.category.default_taxes"), "#dc2626", "landmark" ],
          [ I18n.t("models.category.default_loan_payments"), "#e11d48", "credit-card" ],
          [ I18n.t("models.category.default_services"), "#7c3aed", "briefcase" ],
          [ I18n.t("models.category.default_fees"), "#6b7280", "receipt" ],
          [ I18n.t("models.category.default_savings_and_investments"), "#059669", "piggy-bank" ],
